...
class Test_download_files(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.test_list = ['https://unsplash.com/photos/tgDyb7H40-c/download?force=true',
    ...
    def test_read_url_file(self):
        ...
        self.assertEqual(self.readUrlFile.read_url_file(self.read_file_regex), self.test_list)
    ...
    def test_extract_image_names(self):
        ...
        self.assertListEqual(self.extractName.extract_image_names(url_list, self.extract_name_regex), self.image_name_list)


    def test_download_from_url(self):

        urls = self.downloadUrl.read_url_file(self.read_file_regex)
        images = self.downloadUrl.extract_image_names(urls, self.extract_name_regex)

        self.assertEqual(self.downloadUrl.download_from_url(urls, images, self.download_dir_path), self.downloaded_images)
